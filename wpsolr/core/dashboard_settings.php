                            ...
                            <div class='indexing_option wrapper'>
                                ...
                                <div class="wdm_row">
                                    ...
                                    <div class='col_right'>
										...
										<?php
										$post_types_opt = WPSOLR_Service_Container::getOption()->get_option_index_post_types_str();
										// Sort post types
										asort( $post_types );
				...
				case 'sort_opt':
                    ...
                    <div id="solr-sort-options" class="wdm-vertical-tabs-content">
                        <form action="options.php" method="POST" id='sort_settings_form'>
							...
							$selected_array         = WPSOLR_Service_Container::getOption()->get_sortby_items_as_array();
    ...
    <div id="solr-option-tab">
		...
		$subtabs = [
			'extension_scoring_opt'             => [
				...
				'class' => wpsolr_get_extension_tab_class( OptionLicenses::LICENSE_PACKAGE_SCORING ),
			],
			'extension_yoast_seo_opt'           => [
				'name'  => '>> Yoast SEO',
				'class' => wpsolr_get_extension_tab_class( OptionLicenses::LICENSE_PACKAGE_YOAST_SEO ),
			],
			'extension_all_in_one_seo_opt'      => [
				'name'  => '>> All in One SEO',
				'class' => wpsolr_get_extension_tab_class( OptionLicenses::LICENSE_PACKAGE_ALL_IN_ONE_SEO_PACK ),
			],
			'extension_theme_opt'               => [
				'name'  => '>> Theme',
			...
			'extension_wp_all_import_opt'       => [
				'name'  => '>> WP All Import',
				'class' => wpsolr_get_extension_tab_class( OptionLicenses::EXTENSION_WP_ALL_IMPORT ),
			],
		];
		...
		case 'solr_feedback':
			?>
            <div class="wdm_note">
                Use the popup window in the right bottom corner of the screen to reach us.<br/>
                Let us any feedbacks /suggestions that could help improve the plugin.
            </div>
            <!-- Start of gotosolr Zendesk Widget script -->
            <script>/*<![CDATA[*/window.zEmbed||function(e,t){var n,o,d,i,s,a=[],r=document.createElement("iframe");window.zEmbed=function(){a.push(arguments)},window.zE=window.zE||window.zEmbed,r.src="javascript:false",r.title="",r.role="presentation",(r.frameElement||r).style.cssText="display: none",d=document.getElementsByTagName("script"),d=d[d.length-1],d.parentNode.insertBefore(r,d),i=r.contentWindow,s=i.document;try{o=s}catch(e){n=document.domain,r.src='javascript:var d=document.open();d.domain="'+n+'";void(0);',o=s}o.open()._l=function(){var e=this.createElement("script");n&&(this.domain=n),e.id="js-iframe-async",e.src="https://assets.zendesk.com/embeddable_framework/main.js",this.t=+new Date,this.zendeskHost="gotosolr.zendesk.com",this.zEQueue=a,this.body.appendChild(e)},o.write('<body onload="document._l();">'),o.close()}();
                /*]]>*/</script>
            <!-- End of gotosolr Zendesk Widget script -->
			<?php
			break;
		}
