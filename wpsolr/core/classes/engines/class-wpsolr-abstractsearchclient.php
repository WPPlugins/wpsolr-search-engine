...
abstract class WPSOLR_AbstractSearchClient extends WPSOLR_AbstractEngineClient {
	...
	static function get_search_page() {
		...
		$search_page_slug = apply_filters( WpSolrFilters::WPSOLR_FILTER_SEARCH_PAGE_SLUG, WPSOLR_Service_Container::getOption()->get_search_ajax_search_page_slug() );
	...
	public function set_query_select( WPSOLR_Query $wpsolr_query ) {
		...
		$wpsolr_query = apply_filters( WpSolrFilters::WPSOLR_FILTER_UPDATE_WPSOLR_QUERY, $wpsolr_query );
		...
		$this->search_engine_client_set_rows( WPSOLR_Service_Container::getOption()->get_search_max_nb_results_by_page() );
