...
class WPSOLR_Metabox {
	...
	public function action_add_meta_boxes_callback( $post ) {
		...
		<?php
		if ( file_exists( $file_to_include = apply_filters( WpSolrFilters::WPSOLR_FILTER_INCLUDE_FILE, WPSOLR_Help::HELP_ACF_FIELD_FILE ) ) ) {
			require $file_to_include;
		}
		?>

		<?php
		if ( file_exists( $file_to_include = apply_filters( WpSolrFilters::WPSOLR_FILTER_INCLUDE_FILE, WPSOLR_Help::HELP_TOOLSET_FIELD_FILE ) ) ) {
			require $file_to_include;
		}
		?>
