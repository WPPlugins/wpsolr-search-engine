...
class WPSOLR_Option {
	 ...
	 * @return array
	 */
	public function get_option( $option_name, $option_default_value = [] ) {

		if ( defined( 'WPSOLR_OPTIONS_NO_CACHE' ) && WPSOLR_OPTIONS_NO_CACHE ) {
	...
	private function get_option_value( $caller_function_name, $option_name, $option_key, $option_default = null ) {
		...
		if ( ! empty( $caller_function_name ) ) {
			...
			$result = apply_filters( WpSolrFilters::WPSOLR_FILTER_BEFORE_GET_OPTION_VALUE, null, [
	...
	public function get_sortby_default() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_SORTBY, self::OPTION_SORTBY_ITEM_DEFAULT, WPSOLR_SearchSolariumClient::SORT_CODE_BY_RELEVANCY_DESC );
	}
	...
	public function get_sortby_items() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_SORTBY, self::OPTION_SORTBY_ITEM_ITEMS, WPSOLR_SearchSolariumClient::SORT_CODE_BY_RELEVANCY_DESC );
	}
	...
	public function get_sortby_items_labels() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_SORTBY, self::OPTION_SORTBY_ITEM_LABELS, [] );
	}

	public function get_option_installation() {

		if ( ! self::get_option( self::OPTION_INSTALLATION, false ) ) {
	...
	public function get_search_ajax_search_page_slug() {
		$result = $this->get_option_value( __FUNCTION__, self::OPTION_SEARCH, self::OPTION_SEARCH_AJAX_SEARCH_PAGE_SLUG, WPSOLR_SearchSolariumClient::_SEARCH_PAGE_SLUG );
	...
	public function get_facets_to_show_as_hierarchy() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_FACET, self::OPTION_FACET_FACETS_TO_SHOW_AS_HIERARCH, [] );
	}
	...
	public function get_facets_labels() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_FACET, self::OPTION_FACET_FACETS_LABEL, [] );
	}
	...
	public function get_facets_seo_permalink_templates() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_FACET, self::OPTION_FACET_FACETS_SEO_PERMALINK_TEMPLATE, [] );
	}
	...
	public function get_facets_seo_permalink_positions() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_FACET, self::OPTION_FACET_FACETS_SEO_PERMALINK_POSITION, [] );
	}
	...
	public function get_facets_seo_permalink_items_templates() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_FACET, self::OPTION_FACET_FACETS_SEO_PERMALINK_ITEMS_TEMPLATE, [] );
	}
	...
	public function get_facets_seo_is_permalinks() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_FACET, self::OPTION_FACET_FACETS_SEO_IS_PERMALINK, [] );
	}
	...
	public function get_facets_items_labels() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_FACET, self::OPTION_FACET_FACETS_ITEMS_LABEL, [] );
	}
	...
	public function get_facets_items_is_default() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_FACET, self::OPTION_FACET_FACETS_ITEMS_IS_DEFAULT, [] );
	}
	...
	public function get_facets_sort() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_FACET, self::OPTION_FACET_FACETS_SORT, [] );
	}
	...
	public function get_facets_is_exclusion() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_FACET, self::OPTION_FACET_FACETS_IS_EXCLUSION, [] );
	}
	...
	public function get_facets_layouts_ids() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_FACET, self::OPTION_FACET_FACETS_LAYOUT, [] );
	}
	...
	public function get_facets_grid() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_FACET, self::OPTION_FACET_FACETS_GRID, [] );
	}
	...
	public function get_option_is_installed() {
		...
		return self::get_option( self::OPTION_INSTALLATION, false );
	}
	...
	public function get_option_index_post_types_str() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_INDEX, self::OPTION_INDEX_POST_TYPES, '' );
	}
	...
	public function get_option_index_post_excludes_ids() {
		return $this->explode( $this->get_option_value( __FUNCTION__, self::OPTION_INDEX, self::OPTION_INDEX_POST_EXCLUDES_IDS, '' ) );
	}
	...
	public function get_option_index_custom_field_properties() {
		$custom_field_properties = $this->get_option_value( __FUNCTION__, self::OPTION_INDEX, self::OPTION_INDEX_CUSTOM_FIELD_PROPERTIES, [] );
		...
		if ( $has_been_filtered ) {
			...
			$option                                               = self::get_option( self::OPTION_INDEX, [] );
	...
	public function get_option_boost() {
		return self::get_option( self::OPTION_SEARCH_FIELDS, [] );
	}
	...
	public function get_search_fields_boosts() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_SEARCH_FIELDS, self::OPTION_SEARCH_FIELDS_BOOST, [] );
	}
	...
	public function get_search_fields_terms_boosts() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_SEARCH_FIELDS, self::OPTION_SEARCH_FIELDS_TERMS_BOOST, [] );
	}
	...
	public function get_option_embed_any_document() {
		return self::get_option( self::OPTION_EXTENSION_EMBED_ANY_DOCUMENT, [] );
	}
	...
	public function get_embed_any_document_is_do_embed_documents() {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_EMBED_ANY_DOCUMENT, self::OPTION_EMBED_ANY_DOCUMENT_IS_EMBED_DOCUMENTS ) );
	}
	...
	public function get_option_pdf_embedder() {
		return self::get_option( self::OPTION_EXTENSION_PDF_EMBEDDER, [] );
	}
	...
	public function get_pdf_embedder_is_do_embed_documents() {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_PDF_EMBEDDER, self::OPTION_PDF_EMBEDDER_IS_EMBED_DOCUMENTS ) );
	}
	...
	public function get_option_google_doc_embedder() {
		return self::get_option( self::OPTION_EXTENSION_GOOGLE_DOC_EMBEDDER, [] );
	}
	...
	public function get_google_doc_embedder_is_do_embed_documents() {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_GOOGLE_DOC_EMBEDDER, self::OPTION_GOOGLE_DOC_EMBEDDER_IS_EMBED_DOCUMENTS ) );
	}
	...
	public function get_option_tablepress() {
		return self::get_option( self::OPTION_EXTENSION_TABLEPRESS, [] );
	}
	...
	public function get_tablepress_is_index_shortcodes() {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_TABLEPRESS, self::OPTION_TABLEPRESS_IS_INDEX_SHORTCODES ) );
	}
	...
	public function get_option_geolocation() {
		return self::get_option( self::OPTION_EXTENSION_GEOLOCATION );
	}
	...
	public function get_option_geolocation_is_show_user_agreement_ajax() {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_GEOLOCATION, self::OPTION_GEOLOCATION_IS_SHOW_USER_AGREEMENT_AJAX ) );
	}
	...
	public function get_option_geolocation_is_show_user_agreement_ajax_is_default_yes() {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_GEOLOCATION, self::OPTION_GEOLOCATION_IS_SHOW_USER_AGREEMENT_AJAX_IS_DEFAULT_YES ) );
	}
	...
	public function get_option_geolocation_jquery_selector() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_GEOLOCATION, self::OPTION_GEOLOCATION_JQUERY_SELECTOR, '' );
	}
	...
	public function get_option_geolocation_selector_user_aggreement() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_GEOLOCATION, self::OPTION_GEOLOCATION_JQUERY_SELECTOR_USER_AGREEMENT, '' );
	}
	...
	public function get_option_geolocation_user_aggreement_label() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_GEOLOCATION, self::OPTION_GEOLOCATION_USER_AGREEMENT_LABEL, '' );
	}
	...
	public function get_option_geolocation_default_sort() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_GEOLOCATION, self::OPTION_GEOLOCATION_DEFAULT_SORT, '' );
	}
	...
	public function get_option_geolocation_result_distance_label() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_GEOLOCATION, self::OPTION_GEOLOCATION_RESULT_DISTANCE_LABEL, '' );
	}
	...
	public function get_option_geolocation_is_filter_results_with_empty_coordinates() {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_GEOLOCATION, self::OPTION_GEOLOCATION_IS_FILTER_EMPTY_COORDINATES ) );
	}
	...
	public function get_option_plugin_woocommerce() {
		return self::get_option( self::OPTION_EXTENSION_WOOCOMMERCE, [] );
	}
	...
	public function get_option_plugin_woocommerce_is_replace_admin_orders_search() {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_WOOCOMMERCE, self::OPTION_PLUGIN_WOOCOMMERCE_IS_REPLACE_ADMIN_ORDERS_SEARCH ) );
	}
	...
	public function get_option_plugin_woocommerce_is_replace_sort_items() {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_WOOCOMMERCE, self::OPTION_PLUGIN_WOOCOMMERCE_IS_REPLACE_SORT_ITEMS ) );
	}
	...
	public function get_option_plugin_woocommerce_is_replace_product_category_search() {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_WOOCOMMERCE, self::OPTION_PLUGIN_WOOCOMMERCE_IS_REPLACE_PRODUCT_CATEGORY_SEARCH ) );
	}
	...
	public function get_option_acf() {
		return self::get_option( self::OPTION_EXTENSION_ACF, [] );
	}
	...
	public function get_plugin_acf_google_map_api_key() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_EXTENSION_ACF, self::OPTION_PLUGIN_ACF_GOOGLE_MAP_API_KEY, '' );
	}
	...
	public function get_option_premium() {
		return self::get_option( self::OPTION_PREMIUM, [] );
	}
	...
	public function get_option_updates() {
		return self::get_option( self::OPTION_UPDATES, [] );
	}
	...
	public function get_option_theme() {
		return self::get_option( self::OPTION_THEME, [] );
	}
	...
	public function get_option_seo_common_permalinks_home( $option_name ) {
		return trim( $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_PERMALINKS_HOME, '' ), ' /' );
	}
	...
	public function get_option_seo_template_meta_title( $option_name ) {
		return $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_TEMPLATE_META_TITLE, '' );
	}
	...
	public function get_option_seo_open_graph_image_id( $option_name ) {
		return $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_OPEN_GRAPH_IMAGE, '' );
	}
	...
	public function get_option_seo_template_meta_description( $option_name ) {
		return $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_TEMPLATE_META_DESCRIPTION, '' );
	}
	...
	public function get_option_seo_common_is_redirect_facet_to_permalink_home( $option_name ) {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_IS_REDIRECT_FACETS_PERMALINKS_HOME ) );
	}
	...
	public function get_option_seo_common_permalinks_is_tag_nofollow( $option_name ) {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_IS_PERMALINKS_NOFOLLOW ) );
	}
	...
	public function get_option_seo_common_permalinks_is_tag_noindex( $option_name ) {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_IS_PERMALINKS_NOINDEX ) );
	}
	...
	public function get_option_seo_common_contents_is_tag_nofollow( $option_name ) {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_IS_CONTENTS_NOFOLLOW ) );
	}
	...
	public function get_option_seo_common_contents_is_tag_noindex( $option_name ) {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_IS_CONTENTS_NOINDEX ) );
	}
	...
	public function get_option_seo_common_permalinks_usage( $option_name ) {
		return $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_PERMALINKS_USAGE, '' );
	}
	...
	public function get_option_seo_common_is_replace_search( $option_name ) {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_PERMALINKS_IS_REDIRECT_FROM_SEARCH, '' ) );
	}
	...
	public function get_option_seo_common_is_generate_facet_permalinks( $option_name ) {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_IS_GENERATE_FACETS_PERMALINKS ) );
	}
	...
	public function get_option_seo_common_is_generate_keyword_permalinks( $option_name ) {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_IS_GENERATE_KEYWORDS_PERMALINKS ) );
	}
	...
	public function get_option_seo_common_is_remove_test_mode( $option_name ) {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, $option_name, self::OPTION_SEO_IS_REMOVE_TEST_MODE ) );
	}
	...
	public function get_option_yoast_seo() {
		return self::get_option( self::OPTION_YOAST_SEO, [] );
	}
	...
	public function get_option_all_in_one_seo_pack() {
		return self::get_option( self::OPTION_ALL_IN_ONE_SEO_PACK, [] );
	}
	...
	public function get_option_db() {
		return self::get_option( self::OPTION_DB, [] );
	}
	...
	public function get_db_current_version() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_DB, self::OPTION_DB_CURRENT_VERSION, '' );
	}
	...
	public function get_option_wp_all_import_pack() {
		return self::get_option( self::OPTION_WP_ALL_IMPORT, [] );
	}
	...
	public function get_option_import_export() {
		return self::get_option( self::OPTION_IMPORT_EXPORT, [] );
	}
	...
	public function get_option_licenses() {
		return self::get_option( self::OPTION_LICENSES, [] );
	}
	...
	public function get_option_groups() {
		return self::get_option( self::OPTION_EXTENSION_GROUPS, [] );
	}
	...
	public function get_option_s2member() {
		return self::get_option( self::OPTION_EXTENSION_S2MEMBER, [] );
	}
	...
	public function get_option_wpml() {
		return self::get_option( self::OPTION_EXTENSION_WPML, [] );
	}
	...
	public function get_option_polylang() {
		return self::get_option( self::OPTION_EXTENSION_POLYLANG, [] );
	}
	...
	public function get_option_operations() {
		return self::get_option( self::OPTION_OPERATIONS, [] );
	}
	...
	public function get_option_toolset_types() {
		return self::get_option( self::OPTION_EXTENSION_TYPES, [] );
	}
	...
	public function get_option_bbPress() {
		return self::get_option( self::OPTION_EXTENSION_BBPRESS, [] );
	}
	...
	public function get_option_scoring() {
		return self::get_option( self::OPTION_SCORING );
	}
	...
	public function get_option_scoring_is_decay() {
		return ! $this->is_empty( $this->get_option_value( __FUNCTION__, self::OPTION_SCORING, self::OPTION_SCORING_IS_DECAY ) );
	}
	...
	public function get_option_scoring_fields_decays_origins() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_SCORING, self::OPTION_SCORING_DECAY_ORIGINS, [] );
	}
	...
	public function get_option_scoring_fields_decays_values() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_SCORING, self::OPTION_SCORING_DECAY_VALUES, [] );
	}
	...
	public function get_option_scoring_fields_decays_scales() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_SCORING, self::OPTION_SCORING_DECAY_SCALES, [] );
	}
	...
	public function get_option_scoring_fields_decays_offsets() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_SCORING, self::OPTION_SCORING_DECAY_OFFSETS, [] );
	}
	...
	public function get_option_scoring_fields_decays_functions() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_SCORING, self::OPTION_SCORING_DECAY_FUNCTIONS, [] );
	}
	...
	public function get_option_scoring_fields_decays_str() {
		return $this->get_option_value( __FUNCTION__, self::OPTION_SCORING, self::OPTION_SCORING_DECAY_FIELDS, '' );
	}
