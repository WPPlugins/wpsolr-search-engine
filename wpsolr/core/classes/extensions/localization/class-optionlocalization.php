...
class OptionLocalization extends WpSolrExtensions {
	...
	static function get_default_options() {
		...
		return [
			...
			self::TERMS           => [
				...
				/* Sort */
				WPSOLR_SearchSolariumClient::SORT_CODE_BY_RELEVANCY_DESC       => _x( 'More relevant', 'Sort list element', 'wpsolr' ),
				WPSOLR_SearchSolariumClient::SORT_CODE_BY_DATE_ASC             => _x( 'Oldest', 'Sort list element', 'wpsolr' ),
				WPSOLR_SearchSolariumClient::SORT_CODE_BY_DATE_DESC            => _x( 'Newest', 'Sort list element', 'wpsolr' ),
				WPSOLR_SearchSolariumClient::SORT_CODE_BY_NUMBER_COMMENTS_ASC  => _x( 'The more commented', 'Sort list element', 'wpsolr' ),
				WPSOLR_SearchSolariumClient::SORT_CODE_BY_NUMBER_COMMENTS_DESC => _x( 'The least commented', 'Sort list element', 'wpsolr' ),
	...
	static function get_options( $is_internal_localized = null ) {
		...
		$is_internal_localized = is_bool( $is_internal_localized ) ? $is_internal_localized : WPSOLR_Service_Container::getOption()->get_localization_is_internal();
