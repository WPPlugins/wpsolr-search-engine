				...
				foreach ( ( isset( $option_data['solr_indexes'] ) ? $option_data['solr_indexes'] : [] ) as $index_indice => $index ) {
                    ...
                    <div
                        ...
                        <div class="wdm_row">
                            ...
                            <div class='col_right'>
								<?php $is_engine_solr = empty( $option_data['solr_indexes'][ $index_indice ][ WPSOLR_AbstractEngineClient::ENGINE ] ) || ( WPSOLR_AbstractEngineClient::ENGINE_SOLR === $option_data['solr_indexes'][ $index_indice ][ WPSOLR_AbstractEngineClient::ENGINE ] ); ?>
								<?php if ( ! $is_index_readonly && $is_index_in_creation ) { ?>
                                    ...
                                    >
                                        <option value="<?php echo WPSOLR_AbstractEngineClient::ENGINE_SOLR; ?>" <?php selected( $is_engine_solr ) ?>>
                                            Apache Solr
                                        </option>
                                        <option
                                                value="<?php echo WPSOLR_AbstractEngineClient::ENGINE_ELASTICSEARCH; ?>" <?php selected( ! $is_engine_solr ) ?>>
                                            Elasticsearch
                                        </option>
                                    </select>
								...
								<?php } else { ?>
                                    <input type='hidden'
										...
										<?php echo ( $subtab === $index_indice ) ? "id='index_engine'" : "" ?>
                                           value="<?php echo empty( $option_data['solr_indexes'][ $index_indice ][ WPSOLR_AbstractEngineClient::ENGINE ] ) ? '' : $option_data['solr_indexes'][ $index_indice ][ WPSOLR_AbstractEngineClient::ENGINE ]; ?>"
                                    >
